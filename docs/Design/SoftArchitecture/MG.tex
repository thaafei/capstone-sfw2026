...
\item [\refstepcounter{mnum} \mthemnum \label{mBH5}:] Metrics Storage Module
\item [\refstepcounter{mnum} \mthemnum \label{mBH6}:] Package Storage Module
\item [\refstepcounter{mnum} \mthemnum \label{mBH7}:] Domain Storage Module
\item [\refstepcounter{mnum} \mthemnum \label{mBH8}:] Automated Metrics Module
\item [\refstepcounter{mnum} \mthemnum \label{mBH9}:] Localization Module
...
\item[Services:] Handles user inputs and displays the data of a specific domain.
...
\item[Services:]  Handles and validates user inputs and displays the user-inputted data.
\item[Implemented By:] \projname
\item[Type of Module:] ADT
\end{description}
...
\subsubsection{ Metrics Storage Module (\mref{mBH5})}
\begin{description}
...
\subsubsection{ Package Storage Module (\mref{mBH6})}
\begin{description}
...
\subsubsection{ Domain Storage Module (\mref{mBH7})}
\begin{description}
...
\subsubsection{ Automated Metrics Module (\mref{mBH8})}
\begin{description}
...
\subsubsection{Localization Module (\mref{mBH9})}
\begin{description}
...
\subsubsection{Database Configuration Module (\mref{mSD8})}
\begin{description}
\item[Secrets:] The algorithms and parameters used for interacting with the database.
\item[Services:] Provides database methods related to updating and querying the stored data.
...
\midrule
FR1 & \mref{mBH6}\\
FR2 & \mref{mBH5}, \mref{mBH6}\\
FR3 & \mref{mBH5}\\
FR4 & \mref{mBH5}\\
FR5 & \mref{mBH7}, \mref{mBH3}, \mref{mBH6}  \\
FR6 & \mref{mBH1}, \mref{mBH3},  \mref{mBH6}  \\
FR7 & \mref{mBH1}, \mref{mBH2}, \mref{mBH3}, \mref{mBH4}, \mref{mBH5},  \mref{mBH6},   \mref{mSD3} \\
FR8 & \mref{mBH2}, \mref{mBH3}, \mref{mBH4}, \mref{mBH5},  \mref{mBH6}, \mref{mBH7}\\
FR9 &  \mref{mBH2}, \mref{mBH3}, \mref{mBH4}, \mref{mBH5},  \mref{mBH6}, \mref{mBH7}, \mref{mSD4}, \mref{mSD5}  \\
FR10 & \mref{mBH2}, \mref{mBH3}, \mref{mBH4}, \mref{mBH8}\\
FR11 & \mref{mBH1}, \mref{mBH5}, \mref{mBH6}, \mref{mBH7}\\
