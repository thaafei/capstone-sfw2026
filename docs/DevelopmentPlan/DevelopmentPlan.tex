...
This software and associated documentation files for this project are protected by copywrite as dictated by the \href{https://github.com/thaafei/DomainX/blob/main/LICENSE}{MIT License}.

\section{Copyright License}
This project use's the MIT License, located in the \href{https://github.com/thaafei/DomainX/blob/main/LICENSE}{LICENSE} file.
...
\textbf{M*/*}: Prefixing with M indicates this is an epic branch. \\
\textbf{R*/*}: Prefixing with R indicates this is a review branch. Used for either implementing peer or TA feedback. \\
...
\subsubsection*{Difficulty communicating with the Domain Expert}\vspace{-0.5em}
